...
export function ExternalMLProviderEnumFromJSON(
	json: any,
): ExternalMLProviderEnum {
	return ExternalMLProviderEnumFromJSONTyped(json, false);
}

export function ExternalMLProviderEnumFromJSONTyped(
	json: any,
...
export function ExternalMLProviderEnumToJSON(
	value?: ExternalMLProviderEnum | null,
): any {
	return value as any;
}
