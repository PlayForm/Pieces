...
export function SensitiveCategoryEnumFromJSON(
	json: any,
): SensitiveCategoryEnum {
	return SensitiveCategoryEnumFromJSONTyped(json, false);
}

export function SensitiveCategoryEnumFromJSONTyped(
	json: any,
...
export function SensitiveCategoryEnumToJSON(
	value?: SensitiveCategoryEnum | null,
): any {
	return value as any;
}
