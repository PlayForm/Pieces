 ...
 */
export function instanceOfPreupdatedExternalProviderApiKey(
	value: object,
): boolean {
	let isInstance = true;
...
export function PreupdatedExternalProviderApiKeyFromJSON(
	json: any,
): PreupdatedExternalProviderApiKey {
	return PreupdatedExternalProviderApiKeyFromJSONTyped(json, false);
}

export function PreupdatedExternalProviderApiKeyFromJSONTyped(
	json: any,
...
export function PreupdatedExternalProviderApiKeyToJSON(
	value?: PreupdatedExternalProviderApiKey | null,
): any {
	if (value === undefined) {
		return undefined;
	}
