...
export class GithubApi extends runtime.BaseAPI {
	 ...
	 */
	async importGithubGistsRaw(
		requestParameters: ImportGithubGistsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Seeds>> {
		...
		const response = await this.request(
			{
				...
				body: SeededGithubGistsImportToJSON(
					requestParameters.seededGithubGistsImport,
				),
			},
			initOverrides,
		);
	 ...
	 * /github/gists/import [POST]
	 */
	async importGithubGists(
		requestParameters: ImportGithubGistsRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<Seeds> {
		const response = await this.importGithubGistsRaw(
			requestParameters,
			initOverrides,
		);
