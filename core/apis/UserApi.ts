...
export class UserApi extends runtime.BaseAPI {
	 ...
	 */
	async selectUserRaw(
		requestParameters: SelectUserRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<UserProfile>> {
		const queryParameters: any = {};
	...
	async selectUser(
		...
		const response = await this.selectUserRaw(
			requestParameters,
			initOverrides,
		);
		return await response.value();
	 ...
	 */
	async userBetaStatusRaw(
		requestParameters: UserBetaStatusRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<UserBetaStatus>> {
		const queryParameters: any = {};
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			UserBetaStatusFromJSON(jsonValue),
		);
	}
	 ...
	 * /user/beta/status [POST]
	 */
	async userBetaStatus(
		requestParameters: UserBetaStatusRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<UserBetaStatus> {
		const response = await this.userBetaStatusRaw(
			requestParameters,
			initOverrides,
		);
		return await response.value();
	 ...
	 */
	async userUpdateVanityRaw(
		requestParameters: UserUpdateVanityRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<UserProfile>> {
		const queryParameters: any = {};
	 ...
	 * /user/update/vanity [POST]
	 */
	async userUpdateVanity(
		requestParameters: UserUpdateVanityRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<UserProfile> {
		const response = await this.userUpdateVanityRaw(
			requestParameters,
			initOverrides,
		);
		return await response.value();
