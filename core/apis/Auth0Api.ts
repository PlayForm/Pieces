...
export class Auth0Api extends runtime.BaseAPI {
	 ...
	 */
	async auth0LogoutRaw(
		requestParameters: Auth0LogoutRequest,
	...
	async auth0Logout(
		...
		const response = await this.auth0LogoutRaw(
			requestParameters,
			initOverrides,
		);
	 ...
	 */
	async authorizeAuth0Raw(
		requestParameters: AuthorizeAuth0Request,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<ResultedPKCE>> {
		if (
			requestParameters.audience === null ||
			requestParameters.audience === undefined
		) {
			throw new runtime.RequiredError(
				"audience",
				"Required parameter requestParameters.audience was null or undefined when calling authorizeAuth0.",
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				"scope",
				"Required parameter requestParameters.scope was null or undefined when calling authorizeAuth0.",
			);
		}

		if (
			requestParameters.responseType === null ||
			requestParameters.responseType === undefined
		) {
			throw new runtime.RequiredError(
				"responseType",
				"Required parameter requestParameters.responseType was null or undefined when calling authorizeAuth0.",
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				"clientId",
				"Required parameter requestParameters.clientId was null or undefined when calling authorizeAuth0.",
			);
		}

		if (
			requestParameters.codeChallengeMethod === null ||
			requestParameters.codeChallengeMethod === undefined
		) {
			throw new runtime.RequiredError(
				"codeChallengeMethod",
				"Required parameter requestParameters.codeChallengeMethod was null or undefined when calling authorizeAuth0.",
			);
		}

		if (
			requestParameters.codeChallenge === null ||
			requestParameters.codeChallenge === undefined
		) {
			throw new runtime.RequiredError(
				"codeChallenge",
				"Required parameter requestParameters.codeChallenge was null or undefined when calling authorizeAuth0.",
			);
		}

		if (
			requestParameters.responseMode === null ||
			requestParameters.responseMode === undefined
		) {
			throw new runtime.RequiredError(
				"responseMode",
				"Required parameter requestParameters.responseMode was null or undefined when calling authorizeAuth0.",
			);
		}
		...
		if (requestParameters.scope) {
			queryParameters["scope"] = requestParameters.scope.join(
				runtime.COLLECTION_FORMATS["ssv"],
			);
		}
		...
		if (requestParameters.codeChallengeMethod !== undefined) {
			queryParameters["code_challenge_method"] =
				requestParameters.codeChallengeMethod;
		}
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			ResultedPKCEFromJSON(jsonValue),
		);
	}
	 ...
	 * https://auth.pieces.services/authorize [GET]
	 */
	async authorizeAuth0(
		requestParameters: AuthorizeAuth0Request,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<ResultedPKCE> {
		const response = await this.authorizeAuth0Raw(
			requestParameters,
			initOverrides,
		);
		return await response.value();
	 ...
	 */
	async exchangeForAuth0TokenRaw(
		requestParameters: ExchangeForAuth0TokenRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<OAuthToken>> {
		if (
			...
			throw new runtime.RequiredError(
				"grantType",
				"Required parameter requestParameters.grantType was null or undefined when calling exchangeForAuth0Token.",
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				"clientId",
				"Required parameter requestParameters.clientId was null or undefined when calling exchangeForAuth0Token.",
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				"code",
				"Required parameter requestParameters.code was null or undefined when calling exchangeForAuth0Token.",
			);
		}
		...
		if (
			...
			throw new runtime.RequiredError(
				"redirectUri",
				"Required parameter requestParameters.redirectUri was null or undefined when calling exchangeForAuth0Token.",
			);
		}

		if (
			requestParameters.codeVerifier === null ||
			requestParameters.codeVerifier === undefined
		) {
			throw new runtime.RequiredError(
				"codeVerifier",
				"Required parameter requestParameters.codeVerifier was null or undefined when calling exchangeForAuth0Token.",
			);
		}
		...
		if (requestParameters.schema !== undefined) {
			formParams.append(
				...
				new Blob(
					[
						JSON.stringify(
							EmbeddedModelSchemaToJSON(requestParameters.schema),
						),
					],
	 ...
	 * https://auth.pieces.services/oauth/token [POST]
	 */
	async exchangeForAuth0Token(
		requestParameters: ExchangeForAuth0TokenRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<OAuthToken> {
		const response = await this.exchangeForAuth0TokenRaw(
			requestParameters,
			initOverrides,
		);
		return await response.value();
	...
	async getAuth0UserInfoRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Auth0User>> {
		const queryParameters: any = {};
		...
		if (this.configuration?.accessToken) {
			...
			headerParameters["Authorization"] =
				await this.configuration.accessToken("auth0", []);
		}
