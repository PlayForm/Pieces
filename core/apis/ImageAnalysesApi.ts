...
export class ImageAnalysesApi extends runtime.BaseAPI {
	 ...
	 * Your GET endpoint
	 */
	async imageAnalysesSnapshotRaw(
		requestParameters: ImageAnalysesSnapshotRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<ImageAnalyses>> {
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			ImageAnalysesFromJSON(jsonValue),
		);
	}
	 ...
	 * Your GET endpoint
	 */
	async imageAnalysesSnapshot(
		requestParameters: ImageAnalysesSnapshotRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<ImageAnalyses> {
		const response = await this.imageAnalysesSnapshotRaw(
			requestParameters,
			initOverrides,
		);
