...
export class AllocationsApi extends runtime.BaseAPI {
	 ...
	 */
	async allocationsConnectNewCloudRaw(
		requestParameters: AllocationsConnectNewCloudRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<AllocationCloud>> {
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			AllocationCloudFromJSON(jsonValue),
		);
	}
	 ...
	 * /allocations/connect [POST]
	 */
	async allocationsConnectNewCloud(
		requestParameters: AllocationsConnectNewCloudRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<AllocationCloud> {
	 ...
	 */
	async allocationsCreateNewAllocationRaw(
		requestParameters: AllocationsCreateNewAllocationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<AllocationCloud>> {
		const queryParameters: any = {};
	 ...
	 * /allocations/create [POST]
	 */
	async allocationsCreateNewAllocation(
		requestParameters: AllocationsCreateNewAllocationRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<AllocationCloud> {
	 ...
	 */
	async allocationsDeleteAllocationRaw(
		requestParameters: AllocationsDeleteAllocationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	 ...
	 * /allocations/delete [POST]
	 */
	async allocationsDeleteAllocation(
		requestParameters: AllocationsDeleteAllocationRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<string> {
	 ...
	 */
	async allocationsDisconnectCloudRaw(
		requestParameters: AllocationsDisconnectCloudRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<string>> {
		const queryParameters: any = {};
	 ...
	 * /allocations/disconnect [POST]
	 */
	async allocationsDisconnectCloud(
		requestParameters: AllocationsDisconnectCloudRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<string> {
	 ...
	 */
	async allocationsReconnectCloudRaw(
		requestParameters: AllocationsReconnectCloudRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<AllocationCloud>> {
		const queryParameters: any = {};
	 ...
	 * /allocations/reconnect [POST]
	 */
	async allocationsReconnectCloud(
		requestParameters: AllocationsReconnectCloudRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<AllocationCloud> {
	...
	async allocationsSnapshotRaw(
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Allocations>> {
		const queryParameters: any = {};
