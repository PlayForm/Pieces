...
export class OCRAnalysesApi extends runtime.BaseAPI {
	 ...
	 * Your GET endpoint
	 */
	async ocrAnalysesSnapshotRaw(
		requestParameters: OcrAnalysesSnapshotRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<OCRAnalyses>> {
	 ...
	 * Your GET endpoint
	 */
	async ocrAnalysesSnapshot(
		requestParameters: OcrAnalysesSnapshotRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<OCRAnalyses> {
		const response = await this.ocrAnalysesSnapshotRaw(
			requestParameters,
			initOverrides,
		);
